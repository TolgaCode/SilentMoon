...
//     const [favImages, setFavImages] = useState(undefined);
...
//     useEffect(() => {
//         axios.get(import.meta.env.VITE_BE_URL + `/api/meditationimages?level=${level}&category=${category}&favMeditation=${favImages}&description=${description}`, { withCredentials: true })
//             .then((res) => setImages(res.data))
//             .catch((err) => console.error(err))
//         // if level or category changes through button click the api call retrieves the new asked for data
//     }, [level, category, favImages])
